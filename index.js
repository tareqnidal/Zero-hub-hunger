...
import { CommunityBoardController } from './src/backEnd/controller/CommunityBoardController.mjs'
...
app.use((req, res, next) => {
  ...
  delete req.session.flashMessage // Clear it after assigning to avoid repeating messages.
  res.locals.user = req.session.user || null
  next()
})
app.post('/community-board/post', CommunityBoardController.addPost)
